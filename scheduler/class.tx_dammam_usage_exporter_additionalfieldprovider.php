 ...
 *
 */
class tx_dammam_usage_exporter_AdditionalFieldProvider implements tx_scheduler_AdditionalFieldProvider {
	/**
	 * @var array
	 */
	protected $fields = array(
		"header" => array(
			"label" => "<b>Export Settings</b>",
			"type" => "blank",
			"default" => "",
			"style" => ""
		),
		"exportfolder" => array(
			"label" => "Exportfolder",
			"type" => "text",
			"default" => "Enter the path to the Exportfolder",
			"style" => "width:360px;"
		),
		"debuglevel" => array(
			"label" => "Debuglevel",
