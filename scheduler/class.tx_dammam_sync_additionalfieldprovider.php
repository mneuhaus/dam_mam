 ...
 *
 */
class tx_dammam_sync_AdditionalFieldProvider implements tx_scheduler_AdditionalFieldProvider {
	/**
	 * @var array
	 */
	protected $fields = array(
		...
		"mediafolder" => array(
			"label" => "Media Folder",
			"type" => "text",
			"default" => "Enter the path to the Media folder",
			"style" => "width:360px;"
		),
		"max" => array(
			"label" => "Maxmium importfiles per run",
			"type" => "text",
			"default" => "10",
			"style" => "width:360px;"
		),
		"media_pid" => array(
			"label" => "PID of the Media folder",
			"type" => "text",
			"default" => "93",
			"style" => "width:360px;"
		),
