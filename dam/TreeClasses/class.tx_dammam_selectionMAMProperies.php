 ...
 * @subpackage  Selection
 */
class tx_dammam_selectionMAMProperies extends tx_dam_selBrowseTree {
	...
	function tx_dam_selectionMeTypes()	{
		...
		$this->title = $LANG->sL('LLL:EXT:dam_mam/locallang.xml:mam_properties');
		$this->treeName = 'txdammamMAMProperties';
