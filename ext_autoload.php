<?php
return array(
	'tx_dammam_sync' => t3lib_extMgm::extPath('dam_mam', 'scheduler/class.tx_dammam_sync.php'),
	'tx_dammam_sync_additionalfieldprovider' => t3lib_extMgm::extPath('dam_mam', 'scheduler/class.tx_dammam_sync_additionalfieldprovider.php'),
	'tx_dammam_garbage_collector' => t3lib_extMgm::extPath('dam_mam', 'scheduler/class.tx_dammam_garbage_collector.php'),
